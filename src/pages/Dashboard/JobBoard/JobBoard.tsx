...
import JobBoardCard from '@/components/layout/dashboard/jobBoard/JobBoardCard';
import JobBoardSearchPanel from '@/components/layout/dashboard/jobBoard/JobBoardSearchPanel';
