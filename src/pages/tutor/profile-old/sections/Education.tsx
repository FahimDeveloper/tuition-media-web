...
type CollegeInfoSectionProps = EditableSectionProps<CollegeValues> & {
  isDiplomaStudent: boolean;
  onDiplomaToggle: (checked: boolean) => void;
};

type DiplomaInfoSectionProps = EditableSectionProps<DiplomaValues> & {
  isDiplomaStudent: boolean;
  onDiplomaToggle: (checked: boolean) => void;
};

type HigherEducationSectionProps<TValues extends HigherEducationValues> =
  EditableSectionProps<TValues> & {
    title: string;
    modalTitle: string;
...
function SchoolInfoSection({
  ...
  saveError,
  onClearSaveError,
}: EditableSectionProps<SchoolValues>) {
  return (
...
function CollegeInfoSection({
  ...
  return (
    <ProfileEditableSection<CollegeValues, CollegeFormValues>
      ...
      renderAction={({ defaultAction, isSaving: sectionIsSaving }) => (
        <DiplomaToggleAction
          checked={isDiplomaStudent}
          disabled={sectionIsSaving}
          onChange={onDiplomaToggle}
...
function GraduationInfoSection({
  ...
  saveError,
  onClearSaveError,
}: EditableSectionProps<GraduationValues>) {
  return (
...
function PostGraduationInfoSection({
  ...
  saveError,
  onClearSaveError,
}: EditableSectionProps<PostGraduationValues>) {
  return (
    <HigherEducationSection
...
type EducationInfoSectionProps = {
  ...
  onDelete: (sectionKey: EducationSectionKey) => Promise<void> | void;
  onDiplomaToggle: (checked: boolean) => void;
  ...
  return (
    <div className="space-y-6">
      ...
      <PostGraduationInfoSection
        ...
        onDelete={() => onDelete("post_graduation")}
