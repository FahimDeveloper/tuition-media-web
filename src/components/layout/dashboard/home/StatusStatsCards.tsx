import type {CompactStatItem} from '@/components/layout/dashboard/shared/stats/CompactStatsGrid';
import CompactStatsGrid from '@/components/layout/dashboard/shared/stats/CompactStatsGrid';
import {
  HiOutlineBriefcase,
  HiOutlineCheckBadge,
