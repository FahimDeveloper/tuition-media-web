import type {CompactStatItem} from '@/components/common/dashboard/stats/CompactStatsGrid';
import CompactStatsGrid from '@/components/common/dashboard/stats/CompactStatsGrid';
import {
  HiOutlineBriefcase,
  HiOutlineCheckBadge,
