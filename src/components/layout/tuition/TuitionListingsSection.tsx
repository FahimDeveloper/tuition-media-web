...
const TuitionListingsSection = ({tuitions}: TuitionListingsSectionProps) => {
  return (
    <section className="relative overflow-hidden bg-linear-to-b from-brand-50 via-surface to-surface py-24 transition-colors duration-300 dark:from-gray-950 dark:via-gray-950 dark:to-gray-900 sm:py-28">
      <div
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-6 flex items-center justify-between">
          <p className="flex items-center gap-1 text-text-strong dark:text-white/90">
            <MdOutlineManageSearch className="text-2xl text-primary dark:text-brand-300" />
