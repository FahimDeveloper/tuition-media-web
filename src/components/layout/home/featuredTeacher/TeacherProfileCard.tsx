...
const TeacherProfileCard = ({ teacher }: TeacherProfileCardProps) => {
  ...
  return (
    <article className="group border-brand-200/70 bg-surface-elevated shadow-theme-sm hover:border-brand-400/70 hover:shadow-theme-lg dark:border-border dark:hover:bg-brand-500/[0.04] flex h-full flex-col rounded-2xl border p-6 transition-all duration-300 hover:-translate-y-1">
      ...
      <div className="mt-5 grid grid-cols-2 gap-3">
        {metrics.map((metric) => (
          <div
            ...
            className="border-brand-200/80 bg-brand-50/70 dark:border-border dark:bg-brand-500/[0.08] rounded-xl border px-3 py-2 text-center"
          >
      ...
      <div className="border-brand-100 bg-brand-50/50 dark:border-border dark:bg-brand-500/[0.06] mt-5 rounded-lg border px-4 py-3">
      ...
      <div className="border-brand-100 bg-brand-50/50 dark:border-border dark:bg-brand-500/[0.06] mt-4 rounded-lg border px-4 py-3">
        <div className="text-brand-700 dark:text-brand-300 flex items-center gap-2 text-xs font-semibold tracking-[0.08em] uppercase">
